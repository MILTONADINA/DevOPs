-- Count active typed facts per selected hot-window exchange without returning
-- content. Same conversation/project binding as the Function shadow lookups.
CREATE FUNCTION public.find_active_fact_exchanges(
