  ...
  paths: {
    ...
    "/v1/messages": {
      post: {
        ...
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: { type: "object", required: ["model", "messages"], properties: { model: { type: "string" }, messages: { type: "array" }, max_tokens: { type: "integer" } } },
            },
          },
        },
    ...
    "/v1/tokens/count": {
      post: {
        ...
        requestBody: {
          required: true,
          content: { "application/json": { schema: { type: "object", required: ["model", "messages"], properties: { model: { type: "string" }, messages: { type: "array" } } } } },
        },
        responses: {
          "200": {
            description: "Token count",
            content: { "application/json": { schema: { type: "object", properties: { input_tokens: { type: "integer" }, token_count_method: { type: "string" } } } } },
          },
          "400": ERROR_RESPONSE,
        },
      },
    ...
    "/v1/sessions/{id}": {
      get: {
        ...
        responses: { "200": { description: "Session" }, "404": ERROR_RESPONSE },
      },
      delete: {
        summary: "End a session (sets ended_at)",
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }, ORG_ID_QUERY],
        responses: { "200": { description: "Ended" }, "404": ERROR_RESPONSE },
      },
    },
    ...
    "/v1/memory/facts/{id}": {
      delete: {
        ...
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }, { name: "table", in: "query", required: true, schema: { type: "string" } }, ORG_ID_QUERY],
        responses: { "200": { description: "Suppressed" }, "400": ERROR_RESPONSE, "404": ERROR_RESPONSE },
      },
    },
    "/v1/memory/conflicts": {
    ...
    "/v1/config": {
      get: {
        summary: "Org pruning + feature config",
        parameters: [ORG_ID_QUERY],
