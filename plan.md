...
- [x] **Tier C golden queries**. A 50-case synthetic developer-workload
  ...
  structured facts persist it, and the fact, conflict, and audit-status APIs
  filter reads by authenticated scope. Graph and other org-wide APIs remain
  unscoped. The pruner is still out of
