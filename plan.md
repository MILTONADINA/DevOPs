...
- [ ] **Auto-generated guided tours** (~3h). The dashboard now traverses all File/dependency pages and generates deterministic dependency-first order with cycle handling, Previous/Next controls, paths, and source summaries. Generated plain-English narration and real-browser verification remain open.
