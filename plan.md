...
- [ ] **Dashboard `/dashboard/graph` view** (~10h). A vanilla JS route offers pan, zoom, click-to-expand, fuzzy search, and a paged File/dependency tour. The sidebar shows node paths, source-derived summaries, and relationships. Real-browser verification, generated plain-English summaries, and related Tier-2 facts remain open.
